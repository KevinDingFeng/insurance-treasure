 ...
 * All rights reserved.
 *
 * $Id: DateUtil.java 3121 2007-09-06 06:55:15Z ganja $
 */
/* 文档密级：秘密 */
...
public class DateUtil {
	...
	public static final String DATE_FORMAT_MONTHONLY = "yyyy-MM"; // 年/月
	...
	public static final String DATE_FORMAT_DATEMINUTE = "yyyy-MM-dd HH:mm";

	public static final String DATE_FORMAT_DATEMSEL = "yyyy-MM-dd HH:mm:ss:SS";

	public static final String DATE_FORMAT_DATETIME5 = "yyyy-mm-dd hh:mm:ss.fffff";

	public static final String DATE_FORMAT_PAYDATE = "yyyyMMddHHmmss";
	 ...
	 */
	private static SimpleDateFormat sdfMonthOnly = new SimpleDateFormat(
			DateUtil.DATE_FORMAT_MONTHONLY);

	private static SimpleDateFormat sdfYear = new SimpleDateFormat(
			DateUtil.DATE_FORMAT_YEAR);
	...
	// // log.info(DateUtil.curdatetimeproc("2", "-"));
	// // log.info(dd.toString_CIBS(dt));
	// //
	// log.info(DateUtil.toSqlTimestamp(DateUtil.getSysDateStringYMDHMS(),DateUtil.DATE_FORMAT_DATETIME));
	// // log.info(DateUtil.toDate("2007-01-02").toGMTString());
	// }
	...
	public static String toString(java.util.Date dt, String sFmt) {
		...
		} else if (sFmt.equals(DateUtil.DATE_FORMAT_MONTHONLY)) {
			return toString(dt, DateUtil.sdfMonthOnly);
		} else if (sFmt.equals(DateUtil.DATE_FORMAT_YEAR)) {
			return toString(dt, DateUtil.sdfYear);
	...
	public static java.sql.Timestamp getLastDayOfMonth(
		...
		if (obj.isLeapYear(obj.get(Calendar.YEAR))) {
	...
	public static int getMonthOfTimestamp(java.sql.Timestamp timestamp) {
		GregorianCalendar obj = DateUtil.convertToCalendar(timestamp);
		return (obj.get(Calendar.MONTH) + 1);
	}
	...
	public static int getWeekdayOfTimestamp(java.sql.Timestamp timestamp) {
		GregorianCalendar obj = DateUtil.convertToCalendar(timestamp);
		return obj.get(Calendar.DAY_OF_WEEK);
	}
	...
	/**
	 * 在java.util.Date Object上增加/减少几个月
	 * 
	 * @param timestamp
	 *            java.sql.Timestamp instance
	 * @param mon
	 ...
	 * @return java.sql.Timestamp Object
	 */
	public static java.util.Date addYears(java.util.Date date, int mon) {
		GregorianCalendar obj = new GregorianCalendar();
		obj.setTime(date);
		// month : 0 -- 11
		int year = obj.get(Calendar.YEAR);
	 ...
	 * @author C_ZHOUWEI
	 */
	public static String toStringForPay(java.util.Date dt, String forMat) {
		if (dt == null) {
			return "";
		}
		SimpleDateFormat formatter = new SimpleDateFormat(forMat);
		return toString(dt, formatter);
	 ...
	 * @return
	 */
	public static boolean checkDate(java.sql.Timestamp timestamp,
			java.sql.Timestamp timestamp1) {
		return timestamp.getTime() >= timestamp1.getTime() + DAY_MILLI;
	}
	
	public static int getMonths(java.util.Date date1, java.util.Date date2) {
		int iMonth = 0;
		int flag = 0;
		try {
